...
var Html5QrcodeScanner = function () {
	...
	return _createClass(a, [{
		...
		value: function (a) {
			a.style.position = "sticky", a.style.top = 0, a.style.zIndex = 1, a.style.background="white"; a.style.padding = "0px", a.style.border = "1px solid silver", this.__createHeader(a);
			var b = document.createElement("div"),
