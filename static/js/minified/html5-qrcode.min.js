function getLazarSoftScanner() {
	...
	function o(t) {
		...
		(this.sizeOfBlackWhiteBlackRunBothWays = function (e, t, n, r) {
			...
			o < 0 ?
				((a = e / (e - o)), (o = 0)) :
				o >= A.width && ((a = (A.width - 1 - e) / (o - e)), (o = A.width - 1));
			var s = Math.floor(t - (r - t) * a);
			return (
				(a = 1),
				s < 0 ?
				((a = t / (t - s)), (s = 0)) :
				s >= A.height && ((a = (A.height - 1 - t) / (s - t)), (s = A.height - 1)),
	...
	function C(e, t) {
		...
		this.__defineGetter__('Zero', function () {
			...
			(this.divide = function (e) {
				...
				for (
					var t = this.field.Zero, n = this, r = e.getCoefficient(e.Degree), i = this.field.inverse(r); n.Degree >= e.Degree && !n.Zero;
	...
	function _(e) {
		...
		this.__defineGetter__('Zero', function () {
			...
			(this.multiply = function (e, t) {
				return 0 == e || 0 == t ?
					0 :
					1 == e ? t : 1 == t ? e : this.expTable[(this.logTable[e] + this.logTable[t]) % 255];
			});
	}
	...
	(p.rsDecoder = new function (e) {
		...
		(this.runEuclideanAlgorithm = function (e, t, n) {
			...
			for (
				var i = e, a = t, o = this.field.One, s = this.field.Zero, h = this.field.Zero, w = this.field.One; a.Degree >= Math.floor(n / 2);
				...
				a = f;
				for (
					var l = this.field.Zero, c = i.getCoefficient(i.Degree), g = this.field.inverse(c); a.Degree >= i.Degree && !a.Zero;
	...
	(A.vidSuccess = function (e) {
		...
		A.webkit ?
			...
			A.moz ? ((A.video.mozSrcObject = e), A.video.play()) : (A.video.src = e),
			(A.gUM = !0),
	...
	function D() {
		...
		this.__defineGetter__('CrossCheckStateCount', function () {
			...
			(this.crossCheckVertical = function (e, t, n, r) {
				for (
					var i = this.image, a = A.height, o = this.CrossCheckStateCount, s = e; s >= 0 && i[t + s * A.width];
			...
			(this.crossCheckHorizontal = function (e, t, n, r) {
				for (
					var i = this.image, a = A.width, o = this.CrossCheckStateCount, s = e; s >= 0 && i[s + t * A.width];
			...
			(this.findFinderPattern = function (e) {
				...
				for (var i = !1, a = new Array(5), o = r - 1; o < t && !i; o += r) {
					...
					if (this.foundPatternCross(a))
						...
						((r = a[0]), this.hasSkipped && (i = this.haveMultiplyConfirmedCenters()));
				}
	...
	function F(e, t, n, r, i, a, o) {
		...
		(this.find = function () {
			for (
				var t = this.startX, i = this.height, a = t + r, o = n + (i >> 1), s = new Array(0, 0, 0), h = 0; h < i; h++
			) {
	...
	function I(e, t, n) {
		...
		t <= 9 ?
			...
			t >= 10 && t <= 26 ? (this.dataLengthMode = 1) : t >= 27 && t <= 40 && (this.dataLengthMode = 2),
				...
				for (var e = new Array();;) {
					...
					if (7 == t) var n = this.parseECIValue();
						...
						switch (t) {
							...
							case 2:
								for (
									i = this.getRomanAndFigureString(r), a = new Array(i.length), o = 0; o < i.length; o++
								)
									a[o] = i.charCodeAt(o);
								e.push(a);
								break;
	...
	return (
		(A.orderBestPatterns = function (e) {
			...
			if (
				(o >= a && o >= s ?
					((r = e[0]), (n = e[1]), (i = e[2])) :
					s >= o && s >= a ? ((r = e[1]), (n = e[0]), (i = e[2])) : ((r = e[2]), (n = e[0]), (i = e[1])),
					(function (e, t, n) {
						var r = t.x,
							i = t.y;
		...
		_createClass(a, [{
					...
					if (this.html5Qrcode)
						return new Promise(function (a, d) {
							b.html5Qrcode._isScanning &&
								b.html5Qrcode.stop().then(function () {
			...
			},
			{
				...
				value: function (a) {
					...
					(c.innerHTML = 'QR Code '), b.appendChild(c);
