function getLazarSoftScanner() {
	...
	(p.rsDecoder = new function(e) {
		(this.field = e),
			...
			(this.runEuclideanAlgorithm = function(e, t, n) {
				...
				for (
					var i = e, a = t, o = this.field.One, s = this.field.Zero, h = this.field.Zero, w = this.field.One;
					...
					a = f;
					for (
						var l = this.field.Zero, c = i.getCoefficient(i.Degree), g = this.field.inverse(c);
	...
	function D() {
		(this.image = null),
			...
			(this.crossCheckVertical = function(e, t, n, r) {
				for (
					var i = this.image, a = A.height, o = this.CrossCheckStateCount, s = e;
					s >= 0 && i[t + s * A.width];
	...
	function F(e, t, n, r, i, a, o) {
		(this.image = e),
			...
			(this.find = function() {
				for (
					var t = this.startX, i = this.height, a = t + r, o = n + (i >> 1), s = new Array(0, 0, 0), h = 0;
					h < i;
					h++
				) {
				...
				for (var e = new Array(); ; ) {
					...
					if (7 == t) var n = this.parseECIValue();
						...
						switch (t) {
							...
							case 2:
								for (
									i = this.getRomanAndFigureString(r), a = new Array(i.length), o = 0;
									o < i.length;
									o++
								)
									a[o] = i.charCodeAt(o);
